    ...
    if (!projects || !projects.length) {
        projects = [
            ...
            },
            {
                ...
                techDescription: ' Collaboration with two other developers in a timeframe of 14 days. Partial flow of both buyer and seller, including filtering options, order management, notifications about order status.',
            ...
            },
            {
                ...
                techDescription: 'This is a Vanilla JS project, making use of the HTML canvas element. \n\n  Implementing filtering options of pictures as well as drag & drop elements on the canvas. The project was developed in a time frame of two days.',
